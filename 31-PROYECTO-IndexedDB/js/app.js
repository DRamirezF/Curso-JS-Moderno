...
class UI {
    ...
    imprimirCitas() {
        ...
        // Al no pasar un segundo parámetro al transaction, toma automáticamente el readonly
...
function crearDB() {
    ...
    crearDB.onsuccess = function () {
        console.log('Se creó una Base de Datos');

        DB = crearDB.result;

        // Mostrar Citas al cargar (pero el IndexDB ya está listo)
        ui.imprimirCitas();
    };
