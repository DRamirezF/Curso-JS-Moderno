...
function consultarAPI(ciudad, pais) {
    const appId = 'd3d8e6fca8e19fe86c5434f73ed28ca9'
...
function mostrarClima(datos) {
    ...
    // Los grados vienen en Kelvin y los transformamos a centrigados
    const centrigrados = kelvinACentrigrados(temp);
...
// Helpers: Funciones que sólo hacen solamente una acción
